  ...
  const certifications = [
    {
      ...
      year: "2024",
      description: "Mastery of probabilistic models, including N-grams, sequence labeling, and auto-completion algorithms.",
      url: "/certifications/NLP With Probabilistic Models.pdf"
    },
    {
      name: "Natural Language Processing with Classification and Vector Spaces",
      issuer: "DeepLearning.AI",
      year: "2024",
      description: "Foundational NLP techniques: sentiment analysis, vector spaces, and word embeddings.",
      url: "/certifications/NLP With Classification.pdf"
    },
    {
